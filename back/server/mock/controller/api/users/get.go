...
// @Param pagingKey query string false "pagingKey" Format(date-time)
...
func (ctrl *getController) Get(
	...
	err = fs.WalkDir(mock.MockJSONFS, "json/api/users/get_", fs.WalkDirFunc(func(path string, info fs.DirEntry, err error) error {
		if err != nil {
			return err
		}
