...
import (
	...
	ctrl_api_dcf3adb8 "github.com/54m/how-to-gen-tools/back/server/controller/api"
	ctrl_users_8b029cef "github.com/54m/how-to-gen-tools/back/server/controller/api/users"
...
func addRoutes(e *echo.Echo, p *props.ControllerProps, opt *options) {
	...
	{
		ctrl := ctrl_api_dcf3adb8.NewGetHealthCheckController(p)
	...
	{
		ctrl := ctrl_users_8b029cef.NewDeleteUserController(p)
	...
	{
		ctrl := ctrl_users_8b029cef.NewGetController(p)
	...
	{
		ctrl := ctrl_users_8b029cef.NewGetUserController(p)
	...
	{
		ctrl := ctrl_users_8b029cef.NewPostController(p)
	...
	{
		ctrl := ctrl_users_8b029cef.NewPutUserController(p)
